...
router.get('/movies', async (req, res) => await getMovies(req, res, Movie))
...
router.put('/movie/poster', async(req,res) => await changePosterPlaceholder(req,res,Movie))
router.put('/movie/banner', async(req,res) => await changeBannerPlaceholder(req,res,Movie))
